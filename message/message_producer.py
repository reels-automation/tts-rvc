...
def produce_message(msg: str, consumer, minio_client:ITtsGenerator, current_tts:ITtsGenerator):
    ...
    try:
        ...
        raise TtsError(mensaje="Error al producir un mensaje", status_code=500, error_log=ex)